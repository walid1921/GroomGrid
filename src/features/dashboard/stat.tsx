...
const Stat: React.FC<StatProps> = ({ icon, title, value, color }) => {
  ...
  return (
    <div className="flex shadow-md bg-background rounded-lg p-3 sm:p-6 gap-6 items-center">
      <div
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-xl sm:text-3xl leading-none font-bold text-gray-300">{value}</span>
      </div>
    </div>
  );
};
